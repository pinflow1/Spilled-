...
/* ────────────────────────────────────────────────────────────────────────── */
/* Force remove all tap highlights (blue flash) on buttons and interactive elements */
/* ────────────────────────────────────────────────────────────────────────── */
button,
button:active,
button:focus,
...
/* Prevent any default active background color */
button:active {
  background-color: transparent !important;
}

/* Restore text selection only where needed */
