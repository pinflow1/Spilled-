...
export function CardSkeleton() {
  return (
    <div style={{
      width: 200, flexShrink: 0, padding: "20px 18px",
      background: "#141414", borderRadius: 18, minHeight: 210,
...
export function RowSkeleton({ index = 0 }) {
  return (
    <div style={{
      padding: "20px 0", borderBottom: "1px solid #0d0d0d",
