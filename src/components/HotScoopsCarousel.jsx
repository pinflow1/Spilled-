...
export default function HotScoopsCarousel({ stories, onOpenStory }) {
  ...
  if (!stories.length) return (
    <div>
      ...
      <div style={{ display: "flex", gap: CARD_GAP, paddingLeft: 20, paddingRight: 20 }}>
  ...
  return (
    <div>
      {/* Header */}
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 16, padding: "0 20px" }}>
        <span style={{ fontSize: 9, fontWeight: 700, color: "#333", fontFamily: "'DM Mono', monospace", letterSpacing: "0.16em" }}>
          HOT SCOOPS
        </span>
        <span style={{ fontSize: 9, color: "#2a2a2a", fontFamily: "'DM Mono', monospace" }}>
