    ...
    <div style={{ position: "relative", minHeight: "100vh", background: "#0a0a0a", padding: "80px 24px 48px", display: "flex", flexDirection: "column" }}>
      <div style={{ maxWidth: 500, margin: "0 auto", width: "100%" }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <h2 style={{ fontSize: 28, fontWeight: 700, color: "#f5f5f7", marginBottom: 12, fontFamily: "'DM Sans', sans-serif" }}>The Thread, not a headline.</h2>
          <p style={{ fontSize: 16, color: "#aaa", lineHeight: 1.5, fontFamily: "'DM Sans', sans-serif" }}>We detect accelerating trends before they peak – and stitch the full story from first signal to blow‑up.</p>
        </div>

        {/* Graph - green ends at Spilled, gray starts after */}
        <div style={{ background: "#111", border: "1px solid #222", borderRadius: 24, padding: 20, marginBottom: 24 }}>
          <svg width="100%" height="80" viewBox="0 0 400 80" preserveAspectRatio="none">
            {/* Green line - ends exactly at Spilled marker (x=200, y=15) */}
            <path
              d="M0,70 L40,60 L80,55 L120,40 L160,25 L200,15"
              stroke="#00d4aa"
              strokeWidth="2"
              fill="none"
              strokeLinecap="round"
            ...
            />
            {/* Gray line - starts from Spilled marker point */}
            <path
              d="M200,15 L240,25 L280,40 L320,55 L360,65 L400,70"
              stroke="#555"
              strokeWidth="2"
              fill="none"
              strokeLinecap="round"
            ...
            <path
              d="M0,70 L40,60 L80,55 L120,40 L160,25 L200,15 L240,25 L280,40 L320,55 L360,65 L400,70 L400,80 L0,80 Z"
              fill="#00d4aa15"
            />
            {/* Spilled marker (at the peak/transition point) */}
        ...
        <div style={{ background: "#0d0d0d", border: "1px solid #222", borderRadius: 24, padding: 20, marginBottom: 32 }}>
          <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
            <div style={{ width: 36, height: 36, background: "#1a1a1a", borderRadius: 18, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <DrippingS size={20} color="#888" />
            </div>
            <div>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#f5f5f7", fontFamily: "'DM Sans', sans-serif" }}>Spilled</div>
              <div style={{ fontSize: 12, color: "#555", fontFamily: "'DM Mono', monospace" }}>3 hours ago</div>
            </div>
          </div>
          <p style={{ fontSize: 15, color: "#ddd", marginBottom: 16, lineHeight: 1.5, fontFamily: "'DM Sans', sans-serif" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ fontSize: 11, color: "#555", fontFamily: "'DM Mono', monospace" }}>234 comments</span>
          </div>
        </div>
